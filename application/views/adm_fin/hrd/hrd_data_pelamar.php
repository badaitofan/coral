        ...
        <div class="card-body pt-0">
          <div class="table-responsive"> 
            <table class="last-orders-table table" id="last-orders">
              ...
              <tbody>
                <?php foreach ($row_pelamar as $data) {?>
                  <tr> 
                    <td>
                      <div class="user-data">
                        <div><img src="<?= base_url()?>assets/images/dashboard/avtar/2.jpg" alt="avatar"></div>
                        <div> <a href="javascript:void(0)"> 
                            <h4><?= $data['nama_pelamar']?></h4></a><span><?= $data['email_pelamar']?></span></div>
                      </div>
                    </td>
                    <td><?= $data['posisi_pelamar']?></td>
                    <td></td>
                    <td> 
                    ...
                    <a href="<?= $data['surat_lamaran']?>" target="_blank"><i data-feather="download-cloud"></i></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
