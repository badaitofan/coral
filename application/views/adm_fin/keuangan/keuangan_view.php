    ...
    <div class="page-title">
        ...
        <div class="col-xl-4 col-sm-5 box-col-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Dir. Admin & Keuangan</li>
    ...
    <div class="row">
        <div class="col-xl-8 box-col-7 proorder-md-1">
            <div class="card">
                ...
                <h4>Struktur Organisasi - Divisi Keuangan</h4><span>periode RKAP 2025</span>
                </div>
                <div class="card-body">
                    <div class="row">
                    <img class="img-thumbnail" src="<?= base_url()?>assets/images/struktur/direktorat-akuntansi-keuangan.png" itemprop="thumbnail" alt="Image description">
                    </div>
                </div>
            </div>
        </div>
