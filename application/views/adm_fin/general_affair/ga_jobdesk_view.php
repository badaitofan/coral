    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-sm-5 box-col-4">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">GA</li>
...
<div class="container-fluid default-dashboard2">
  <div class="row">
    <div class="col-xl-12 col-md-12 box-col-12">
      <div class="card">
        <div class="card-header card-no-border bg-info font-light">
          <div class="header-top">
            <h4>Daftar Job Description Personel General Affair </h4>
        ...
        <div class="card-body pt-0">
          <div class="table-responsive"> 
            <table class="last-orders-table table" id="last-orders">
              ...
              <tbody>
                <?php foreach ($row_jd_ga as $dataJobdesc) {?>
                  <tr> 
                    <td>
                      <div class="user-data">
