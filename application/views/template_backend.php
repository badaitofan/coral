    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="<?= site_url('Dashboard_Backend')?>"> <img class="img-fluid for-light" src="<?=base_url()?>assets/images/logo/logo-icon.png" alt=""><img class="img-fluid for-dark" src="<?=base_url()?>assets/images/logo/logo-icon.png" alt=""></a></div>
          ...
          <div class="col-sm-4">
            <h3>Corporate Portal - Backend</h3>
      ...
      <div class="page-body-wrapper"> 
        ...
        <div class="sidebar-wrapper" data-layout="stroke-svg">
          <div>
            <div class="logo-wrapper"><a href="<?=site_url('Dashboard_Backend')?>"> <img class="img-fluid for-light" src="<?=base_url()?>assets/images/logo/logo-Coral.png" alt=""><img class="img-fluid for-dark" src="<?=base_url()?>assets/images/logo/logo-Coral-Dark.png" alt=""></a>
              <div class="toggle-sidebar">
                <svg class="sidebar-toggle"> 
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav"  href="<?= site_url('Dashboard_Backend')?>">
                      <svg class="stroke-icon">
                  ...
                  <li class="sidebar-list"> <i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="<?= site_url('Berita_Backend')?>">Daftar Berita</a></li>
                      <li><a href="<?= site_url('Berita_Backend/berita_baru')?>">Buat Berita</a></li>
                      <li><a href="<?= site_url('Berita_Backend/detail_berita')?>" disabled>Detail Berita</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"> <i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="#">
                      <svg class="stroke-icon">
