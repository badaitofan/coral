    ...
    <div class="page-title">
        <div class="row">
            <div class="col-xl-4 col-sm-7 box-col-3">
                <h3>Corporare Secretary - Info General</h3>
            </div>
    ...
    <div class="row">
        <div class="col-xl-8 box-col-7 proorder-md-1">
            <div class="card">
                ...
                <h4>Struktur Organisasi - Divisi Corporate Secretary</h4><span>periode RKAP 2025</span>
                </div>
                <div class="card-body">
                    <div class="row">
                    <img class="img-thumbnail" src="<?= base_url()?>assets/images/struktur/secretary.png" itemprop="thumbnail" alt="Image description">
                    </div>
                </div>
            </div>
        </div>
