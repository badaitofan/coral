                ...
                <div class="card-body">
                  <div class="email-app-sidebar left-bookmark">
                    ...
                    <ul class="nav main-menu custom-scrollbar" role="tablist"> 
                      <li class="nav-item">
                        <a href="javascript:;" class="badge-light-primary btn-block btn-mail txt-primary w-100 catg" type="button" data-category="ALL"><i class="me-2" data-feather="filter"></i> Semua</a>
                      </li>
