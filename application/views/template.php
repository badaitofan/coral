              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-main-title">
                    <div>
                      <h6 class="lan-1">Struktur & Karyawan</h6>
                    </div>
                  </li>
                          ...
                          <div class="col mega-box">
                            <div class="link-section">
                              ...
                              <ul class="submenu-content opensubmegamenu">
                                ...
                                <li><a href="<?=site_url('Adm_Fin/akuntansi_audit_internal')?>" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Lap. Audit Internal">Lap. Audit Internal</a></li>
                  ...
                  <li class="mega-menu sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a href="<?=site_url('BS_Group/jobdesc_bsg')?>">Job Desc</a></li>
