  ...
  <div class="page-title">
    <div class="row">
      <div class="col-xl-4 col-sm-7 box-col-3">
        <h3>General Affair - Data Ekor Trailer</h3>
      </div>
      ...
      <div class="card">
        <div class="card-header pb-0 card-no-border">
          <div class="header-top">
            <h4>Daftar Aset Ekor Trailer GA</h4>
                      ...
                      <div class="user-data">
                        <div>
                          <a href="javascript:void(0)">
                            <h4><?= isset($dataAsset['nama_pemilik']) ? $dataAsset['nama_pemilik'] : 'No Name' ?></h4>
                          </a>
                          <span><?= isset($dataAsset['jenis']) ? $dataAsset['jenis'] : 'No Merk' ?></span>
                        </div>
                      </div>
                    </td>
                    <td><?= $dataAsset['no_rangka'] ?></td>
                    <td><?= $dataAsset['no_uji_kendaraan'] ?></td>
                    <td><?= $dataAsset['status'] ?></td> 
                    <td><?= $dataAsset['keterangan'] ?></td>
