  ...
  <div class="page-title">
    <div class="row">
      <div class="col-xl-6 col-sm-7 box-col-3">
        <h3>Marketing BDP - Dokumen Quotation</h3>
      </div>
      ...
      <div class="card">
        <div class="card-header pb-0 card-no-border">
          <div class="header-top">
            <h4>Daftar Dokumen Quotation Marketing</h4>
            
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive"> 
            <table class="display last-orders-table table" id="last-orders">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                { 
                  ...
                  // }else if($data['contract_status'] == "FINISH"){
                  //   $status = " <span class='badge rounded-pill badge-light gap-2'>FINISHED</span>";
                  ...
                  <tr> 
                    ...
                    <td>
                      <div class="user-data">
                        ...
                        <div> <span style="font-size:10px;margin-left:2px" > Tanggal : <?= $data['quote_date']?> </span>
                          <a href="javascript:void(0)"><h4><?= $data['quote_customer']?></h4></a>
                        </div>
                      </div>
                    </td>
                    <td><?= $data['quote_sales']?></td>
                    <td></td>
                    <td><?= $data['company_name']?></td>
                    <td>
                      <a href="<?= $data['quote_link']?>" target="_blank"><i data-feather="download-cloud"></i></a>
                    </td>
